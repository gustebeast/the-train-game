...
/** Custom glyph model + tint per tool type. Models are generated by
 *  scripts/generate-minimap-icons.js — edit the ASCII art or quad size
 *  there and re-run it to change the icons. */
