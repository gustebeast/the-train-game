...
/** Custom glyph texture + tint per tool type. pingPath must be an IMAGE
 *  (16x16 tga/blp) — a model renders in the wrong coordinate space and
 *  covers the screen. Textures are generated by
 *  scripts/generate-minimap-icons.js — edit the ASCII art there and
 *  re-run it to change the icons. */
const ICON_STYLES = new Map<number, IconStyle>([
  [AXE_ID, { red: 255, green: 80, blue: 40, path: 'war3mapImported\\MinimapAxe.tga' }], // reddish orange
  [PICKAXE_ID, { red: 220, green: 220, blue: 220, path: 'war3mapImported\\MinimapPickaxe.tga' }], // light gray
  [BUCKET_ID, { red: 80, green: 180, blue: 255, path: 'war3mapImported\\MinimapBucket.tga' }], // light blue
  [BUCKET_FULL_ID, { red: 30, green: 100, blue: 255, path: 'war3mapImported\\MinimapBucketFull.tga' }], // deep blue
]);
